<header class="mb-10 flex flex-row justify-between items-end gap-6 no-print">
    <div>
        <h2 class="text-3xl font-black italic uppercase tracking-tighter text-[--text-main] leading-none"><?= $header_title ?? 'Admin <span class="text-primary">(Developer)</span>' ?></h2>
