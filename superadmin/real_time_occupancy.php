...
<header class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
    <div>
        <h2 class="text-3xl font-black italic uppercase tracking-tighter text-white">Live <span class="text-primary">Occupancy</span></h2>
        <p class="text-gray-500 text-xs font-bold uppercase tracking-widest mt-1">Real-time facility usage monitoring</p>
    </div>
    <div class="flex items-center gap-2 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
        <span class="size-2 bg-emerald-500 rounded-full alert-pulse"></span>
        <span class="text-[9px] font-black uppercase text-emerald-500 tracking-widest">Live Updates Active</span>
    </div>
</header>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
    ...
    <div class="glass-card p-8 group hover:border-primary/30 transition-all">
        <div class="flex justify-between items-start mb-6">
            <div>
                <h3 class="text-lg font-black italic uppercase italic text-white"><?= htmlspecialchars($gym['name']) ?></h3>
...
<div class="dashed-container p-12 flex flex-col items-center justify-center text-center">
