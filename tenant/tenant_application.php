...
if (isset($_GET['check_field']) && isset($_GET['value'])) {
    ...
    } elseif (in_array($field, ['email', 'gym_name', 'business_name', 'bir_number', 'business_permit_no', 'owner_valid_id_number'])) {
        // Sanitize for DB check if it's bir_number or owner_valid_id_number
        if ($field === 'bir_number' || $field === 'owner_valid_id_number') $value = str_replace('-', '', $value);
...
<main class="flex-1 flex flex-col items-center py-12 px-4 relative z-10 w-full overflow-x-hidden">
    <div class="w-full max-w-2xl">
        <div class="text-center mb-10">
            <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-primary text-[9px] font-black uppercase tracking-[0.2em] mb-4">
                Partner Registration
            </div>
            <h1 class="text-4xl font-display font-black text-gray-900 dark:text-white uppercase italic tracking-tighter mb-2">Apply for <span class="text-primary">Partnership</span></h1>
            ...
            <div class="w-full bg-black/5 dark:bg-white/5 h-1.5 mt-8 rounded-full overflow-hidden">
        ...
        <form id="multi-step-form" action="../action/submit_application.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="dashboard-window rounded-2xl p-8 md:p-10 relative">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-4 mb-8">
                            ...
                            <h3 class="text-lg font-display font-black text-gray-900 dark:text-white uppercase italic tracking-tight">Owner Account Details</h3>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="first_name" required placeholder="e.g. Juan" autocomplete="given-name" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-[10px] font-bold uppercase tracking-widest text-gray-400 ml-1">Middle Name (Optional)</label>
                            <input type="text" name="middle_name" placeholder="e.g. Santos" autocomplete="additional-name" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="last_name" required placeholder="e.g. Dela Cruz" autocomplete="family-name" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div class="space-y-1.5">
                            ...
                            <input type="email" name="owner_email" required placeholder="e.g. name@example.com" autocomplete="email" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="owner_contact" id="owner_contact" required placeholder="0912-345-6789" maxlength="13" autocomplete="tel" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        <div class="space-y-1.5">
                            ...
                            <input type="date" name="owner_dob" id="owner_dob" required max="<?php echo date('Y-m-d', strtotime('-18 years')); ?>" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <select name="owner_sex" required class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none cursor-pointer appearance-none">
                    ...
                    <div class="space-y-1.5 mb-5">
                        ...
                        <input type="text" name="username" required placeholder="e.g. juan_owner2026" autocomplete="username" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            ...
                            <div class="relative group">
                                <input type="password" id="reg-password" name="password" required placeholder="••••••••" autocomplete="new-password" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md pl-4 pr-12 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative group">
                                <input type="password" id="reg-confirm-password" name="confirm_password" placeholder="••••••••" required autocomplete="new-password" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md pl-4 pr-12 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                ...
                <div class="dashboard-window rounded-2xl p-8 md:p-10 relative">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-4 mb-8">
                            ...
                            <h3 class="text-lg font-display font-black text-gray-900 dark:text-white uppercase italic tracking-tight">Business Profile & Location</h3>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="gym_name" required placeholder="e.g. Iron Forge Gym" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="business_name" required placeholder="e.g. Iron Forge Fitness Inc." class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <input type="email" name="gym_email" required placeholder="gym@example.com" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="gym_contact" id="gym_contact" required placeholder="0912-345-6789" maxlength="13" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5 md:col-span-2">
                            <label class="text-[10px] font-bold uppercase tracking-widest text-gray-400 ml-1">Profile Picture (Gym Logo)</label>
                            <input type="file" name="profile_picture" accept="image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-black/10 dark:bg-white/10 file:text-gray-900 dark:text-white hover:file:bg-black/20 dark:hover:file:bg-white/20 file:transition-all file:cursor-pointer">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="md:col-span-2 space-y-1.5">
                            ...
                            <input type="text" name="gym_address_line" placeholder="Unit No., Street Name" required class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Region <span class="text-red-500">*</span></label>
                            <input type="text" name="region" placeholder="e.g. Central Luzon" required class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Province <span class="text-red-500">*</span></label>
                            <input type="text" name="province" placeholder="e.g. Bulacan" required class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="city" placeholder="e.g. Baliwag" required class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Barangay <span class="text-red-500">*</span></label>
                            <input type="text" name="barangay" placeholder="e.g. Bagong Nayon" required class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="dashboard-window rounded-2xl p-8 md:p-10 relative">
                    ...
                    <div class="relative z-10">
                        <div class="flex items-center gap-4 mb-8">
                            ...
                            <h3 class="text-lg font-display font-black text-gray-900 dark:text-white uppercase italic tracking-tight">Legal & Financial Verification</h3>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                        <div class="space-y-1.5">
                            ...
                            <select name="owner_valid_id_type" required class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none cursor-pointer appearance-none">
                        ...
                        <div class="space-y-1.5">
                            <label class="text-[10px] font-bold uppercase tracking-widest text-gray-400 ml-1">Valid ID Number <span class="text-red-500">*</span></label>
                            <input type="text" name="owner_valid_id_number" id="owner_valid_id_number" required placeholder="e.g. N01-12-123456" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <input type="file" name="owner_valid_id_file" required accept=".pdf,image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-black/10 dark:bg-white/10 file:text-gray-900 dark:text-white hover:file:bg-black/20 dark:hover:file:bg-white/20 file:transition-all file:cursor-pointer">
                        </div>
                        <div class="hidden md:block"></div> <!-- Spacer to keep pairs aligned -->
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="bir_number" id="bir_number" required placeholder="XXX-XXX-XXX-XXX" maxlength="15" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <input type="file" name="bir_document" required accept=".pdf,image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-black/10 dark:bg-white/10 file:text-gray-900 dark:text-white hover:file:bg-black/20 dark:hover:file:bg-white/20 file:transition-all file:cursor-pointer">
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="business_permit_no" id="business_permit_no" required placeholder="BIN-XXX-XX-YYYY-123456" maxlength="22" class="w-full h-12 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md px-4 text-sm text-gray-900 dark:text-white focus:bg-black/10 dark:focus:bg-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all outline-none">
                        </div>
                        <div class="space-y-1.5">
                            ...
                            <input type="file" name="business_permit" required accept=".pdf,image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-black/10 dark:bg-white/10 file:text-gray-900 dark:text-white hover:file:bg-black/20 dark:hover:file:bg-white/20 file:transition-all file:cursor-pointer">
                        </div>
                    </div>
            ...
            <div class="flex gap-4 pt-2">
                <button type="button" id="prev-btn" class="hidden flex-1 h-12 rounded-xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 backdrop-blur-md text-gray-900 dark:text-white font-display font-bold uppercase tracking-widest text-[10px] hover:bg-black/10 dark:hover:bg-white/10 transition-all">
                    Previous
                </button>
...
<script>
    ...
    // Attach masks
    const phoneFields = ['owner_contact', 'gym_contact'];
    ...
    const fieldStates = {
        ...
        owner_valid_id_number: { exists: false, checking: false, timeout: null, label: 'Valid ID Number', dbField: 'owner_valid_id_number' },
    ...
    setupRealTimeValidation('owner_valid_id_number', '#owner_valid_id_number');
    ...
    function checkPasswordStrength(password) {
        ...
        if (password.length > 0) {
            ...
            if (strengthLabel) strengthLabel.textContent = labels[displayStrength - 1];
            if (strengthLabel) strengthLabel.className = colors[displayStrength - 1].replace('bg-', 'text-');
        } else {
            if (strengthLabel) strengthLabel.textContent = 'None';
            if (strengthLabel) strengthLabel.className = 'text-gray-500';
        }
        return strength;
    }
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (fieldStates.bir_number.exists || fieldStates.business_permit_no.exists || fieldStates.owner_valid_id_number.exists) {
            e.preventDefault();
            const dupField = fieldStates.bir_number.exists ? 'bir_number' : (fieldStates.business_permit_no.exists ? 'business_permit_no' : 'owner_valid_id_number');
