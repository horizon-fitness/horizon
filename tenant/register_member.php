...
// Security Check: Only Tenants/Staff
...
<nav class="flex flex-col w-64 bg-[#0a090d] border-r border-white/5 p-8 z-50 shrink-0">
    <div class="mb-12">
    ...
    <div class="flex flex-col gap-5 flex-1 overflow-y-auto no-scrollbar">
        ...
        <a href="register_member.php" class="nav-link flex items-center gap-3 active-nav text-primary">
        ...
        <a href="staff_management.php" class="nav-link flex items-center gap-3 text-gray-400 hover:text-white">
            <span class="material-symbols-outlined text-xl">group</span> Staff Mgmt
        </a>
        <a href="tenant_settings.php" class="nav-link flex items-center gap-3 text-gray-400 hover:text-white">
            <span class="material-symbols-outlined text-xl">palette</span> Customization
        </a>
    </div>
