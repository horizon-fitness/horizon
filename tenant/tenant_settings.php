...
<head>
    ...
    <style>
        ...
        @media (min-height: 900px) { .phone-mockup { transform: scale(0.85); margin-bottom: -100px; } }
        @media (min-height: 1000px) { .phone-mockup { transform: scale(0.95); margin-bottom: -20px; } }
        ...
        .phone-screen { width: 100%; height: 100%; border-radius: 42px; overflow: hidden; background: #000; position: relative; }
    </style>
</head>
