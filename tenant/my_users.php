...
<body class="antialiased flex h-screen overflow-hidden">
    ...
    <main class="main-content flex-1 p-10 overflow-y-auto no-scrollbar">
        ...
        <header class="mb-10 flex justify-between items-end">
            ...
            <div class="flex items-center gap-8">
                <a href="profile.php"
                    class="hidden md:flex items-center gap-2.5 px-6 py-3 rounded-2xl bg-primary/10 border border-primary/20 text-primary text-[10px] font-black uppercase italic tracking-widest hover:bg-primary hover:text-white transition-all active:scale-95 group">
                    <span
                        class="material-symbols-outlined text-lg group-hover:scale-110 transition-transform">account_circle</span>
                    My Profile
                </a>
