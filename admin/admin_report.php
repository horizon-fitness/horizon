...
<head>
    ...
    <style>
        ...
        .tab-item { padding: 10px 24px; border-radius: 12px; font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.05em; transition: all 0.3s ease; color: #666; cursor: pointer; }
        .tab-item:hover { color: white; }
        .tab-item.active { background: <?= $page['theme_color'] ?? '#8c2bee' ?>; color: white; box-shadow: 0 4px 15px rgba(140,43,238,0.3); }
...
<div class="main-content flex flex-col min-w-0">
    <main class="flex-1 p-6 md:p-10 max-w-[1400px] w-full mx-auto">
        <header class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            <div>
                <h1 class="text-3xl font-black text-white italic uppercase tracking-tighter leading-none mb-2">Data <span class="text-primary">Reports</span></h1>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Financial, Attendance, and Membership</p>
            </div>
