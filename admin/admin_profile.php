...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_profile') {
    ...
    try {
        ...
        header("Location: admin_profile.php?status=success&msg=" . urlencode("Profile updated successfully!"));
        exit;
    } catch (Exception $e) {
        ...
        header("Location: admin_profile.php?status=error&msg=" . urlencode($e->getMessage()));
        exit;
    }
}
                                ...
                                <div id="profile-container"
                                    ...
                                    <?php else: ?>
                                        <div id="profilePlaceholder"
                                            ...
                                            <?= strtoupper(($user['first_name'][0] ?? 'A') . ($user['last_name'][0] ?? '')) ?>
                                        </div>
                                    <?php endif; ?>
            ...
            showModal(
                ...
                () => {
                    ...
                    if (!placeholder) {
                        ...
                        newPlaceholder.innerText = "<?= strtoupper(($user['first_name'][0] ?? 'A') . ($user['last_name'][0] ?? '')) ?>";
