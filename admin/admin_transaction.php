...
<head>
    ...
    <style>
        ...
        .custom-input:focus { outline: none; border-color: <?= $page['theme_color'] ?? '#8c2bee' ?>; }
...
<div class="main-content flex flex-col min-w-0">
    <main class="flex-1 p-6 md:p-10 max-w-[1400px] w-full mx-auto">
        ...
        <header class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            <div>
                <h1 class="text-3xl font-black text-white italic uppercase tracking-tighter leading-none mb-2">Transaction <span class="text-primary">History</span></h1>
                <p class="text-gray-500 text-xs font-bold uppercase tracking-widest">Billing Log • Active Pending Records</p>
            </div>
