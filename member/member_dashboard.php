...
<body class="antialiased flex flex-row min-h-screen">
    ...
    <nav class="hidden md:flex flex-col w-64 lg:w-72 bg-[#0a090d] border-r border-white/5 sticky top-0 h-screen p-8 z-50 shrink-0">
        ...
        <div class="flex flex-col gap-8 flex-1">
            <a href="dashboard.php" class="nav-link active-nav flex items-center gap-3">
                <span class="material-symbols-outlined text-xl">grid_view</span> Dashboard
            </a>
            <a href="schedule_user.php" class="nav-link text-gray-400 hover:text-white flex items-center gap-3">
                <span class="material-symbols-outlined text-xl">calendar_month</span> Book Session
            </a>
            <a href="dashboard_payment.php" class="nav-link text-gray-400 hover:text-white flex items-center gap-3">
                <span class="material-symbols-outlined text-xl">payments</span> Payment
            </a>
            <a href="client_membership.php" class="nav-link text-gray-400 hover:text-white flex items-center gap-3">
                <span class="material-symbols-outlined text-xl">card_membership</span> Membership
            </a>
            <a href="appointment.php" class="nav-link text-gray-400 hover:text-white flex items-center gap-3">
    ...
    <div class="flex-1 overflow-x-hidden">
        ...
        <div id="mobileMenu" class="hidden md:hidden bg-[#14121a] border-b border-white/5 p-6 flex flex-col gap-6">
            ...
            <a href="memeber_payment.php" class="nav-link text-gray-400">Payment</a>
        ...
        <main class="max-w-7xl mx-auto p-6 md:p-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
                <div class="glass-card p-8 border-l-4 border-emerald-500 relative overflow-hidden group flex flex-col justify-between">
                    ...
                    <?php elseif ($has_booking_today && !$is_completed_today): ?>
                        <div>
                    ...
                    <?php else: ?>
                        <div>
                            ...
                            <a href="schedule_user.php" class="text-[10px] text-primary font-bold uppercase mt-1 hover:underline">Book Now -></a>
                        </div>
                    <?php endif; ?>
                </div>
